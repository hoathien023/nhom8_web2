                ...
                <div class="col-lg-9 col-md-9">
                    <div class="row">
                        <?php foreach ($list_products as $value) {
                            ...
                            $wishlist_form_id = 'wishlist-cate-' . (int)$product_id;
                        ?>
                                    ...
                                    <div class="rating">
                                        ...
                                        <?php if (isset($_SESSION['user'])): ?>
                                            ...
                                            <form id="<?=$wishlist_form_id?>" action="index.php?url=yeu-thich" method="post" class="wishlist-inline-form" style="display:none;">
                                                ...
                                                <input type="hidden" name="redirect_to" value="index.php?url=danh-muc-san-pham&id=<?=(int)$category_id?>&page=<?=(int)$page?>">
